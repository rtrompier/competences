...
dpd.competences = dpd("/competences");
dpd.competences.on = function(ev, fn) {
  return dpd.on("competences" + ":" + ev, fn);
}
dpd.competences.once = function(ev, fn) {
  return dpd.once("competences" + ":" + ev, fn);
}
dpd.competences.off = function(ev, fn) {
  return dpd.off("competences" + ":" + ev, fn);
}
dpd.competences.rename = function (path, body, fn) {
  dpd.competences.exec("rename", path, body, fn);
}

dpd.situations = dpd("/situations");
dpd.situations.on = function(ev, fn) {
  return dpd.on("situations" + ":" + ev, fn);
}
dpd.situations.once = function(ev, fn) {
  return dpd.once("situations" + ":" + ev, fn);
}
dpd.situations.off = function(ev, fn) {
  return dpd.off("situations" + ":" + ev, fn);
}
dpd.situations.rename = function (path, body, fn) {
  dpd.situations.exec("rename", path, body, fn);
}
